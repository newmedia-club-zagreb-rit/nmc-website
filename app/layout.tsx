...
import { Geist, Geist_Mono, Kodchasan, Permanent_Marker } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${geistSans.variable} ${geistMono.variable} ${kodchasan.variable} ${permanentMarker.variable} h-full antialiased`}
    >
